  ...
  return (
    <div className="flex flex-col h-screen bg-background text-foreground border-r border-gray-600 text-white overflow-auto">
      <div className="sticky top-0 z-10 bg-background p-3">
        <input
          className="h-10 w-full rounded-md border border-gray-300 bg-background px-4 py-2 text-sm text-black placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
